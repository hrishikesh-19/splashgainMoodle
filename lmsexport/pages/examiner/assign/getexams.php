...
if (isset($_POST['courseid'])) {
    ...
    $datatosend = array("GetMoodleExamNameWebAPIInputobj" => array("CourseID" => $courseid));

    $posturl = $apiurl . '/SplashService.svc/GetMoodleSubjectiveExamNameWebAPI';

    $responsearray = get_api_response_withdata($posturl, $datatosend);

    $examslist = $responsearray["GetMoodleSubjectiveExamNameWebAPIResult"];
    ...
    <div>
        <?php if (!empty($examslist)) { ?>
            <div style="margin:5px ;">
                ...
                <select name="examid" id="examid" class="form-control" onchange=" show_shedule('<?php echo $examid; ?>');">
