...
<div class="col-sm-12 table-responsive">
        ...
        foreach ($studlist as $row) {
            ...
            if ($isaspr == 1) {
                ...
                if (in_array($row->id, $_POST['rcbx'])) {
                    echo '<td><input type="checkbox" name="rcbx[]" id="rcbx"  value="' . $row->id . '" checked /></td>';
                } else {
                    echo '<td><input type="checkbox" name="rcbx[]" id="rcbx"  value="' . $row->id . '" /></td>';
                }
    ...
    <div class="col-sm-12 text-center">
        ...
        value="Submit" onclick="show_proclist();" />
    </div>
</div>
