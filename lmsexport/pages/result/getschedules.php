...
<div>
        <?php if (!empty($shedulelist)) { ?>
            <div style="margin:5px ;">
                ...
                <select name="ScheduleID" id="ScheduleID" class="form-control" onchange=" show_examstatus();">
                    <option value="">Select</option>
                    <?php foreach ($shedulelist['MoodleExamScheduleObj'] as $singlesch) {
                    ?>
                        <option value="<?php echo $singlesch['ScheduleID']; ?>"
                            <?php if (isset($_POST['ScheduleID'])) {
    ...
    echo 'Please Select Examination Properly.';
}
