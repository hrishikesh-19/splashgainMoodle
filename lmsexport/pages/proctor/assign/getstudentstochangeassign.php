...
if (isset($_POST['courseid']) && isset($_POST['ExamID']) && isset($_POST['ScheduleID'])) {
    ...
    $datatosend = array("obj" => array("CourseID" => $_POST['courseid'],
...
<div class="col-sm-12 table-responsive">
    ...
    <div class="col-sm-12 text-center">
        ...
        class="m-element-button btn btn-primary" value="Change Assignment" onclick="show_proclist();" />
        <a href="index.php"><button type="button" 
        class="m-element-button btn btn-primary text-right">Go Back</button></a>
    </div>
</div>
</div>
