        ...
        <div class="col-sm-12 row">
            ...
            <div class="col-sm-12 row">
                ...
                <div id="title_ui" class="col-md-6 pt-4 text-left">
                    <h3> Proctor(s) >> Proctor Assignment</h3>
                </div>

                <div class="col-sm-6 pt-4 text-right">

                    <a href="reassignproctor.php"><button class="btn btn-outline-primary">Reassign Proctors</button></a>
...
<script>
    function show_proclist() {
        ...
        if (selarray.length > 0) {
            $("#proctorlist_ui").html('Please Wait')            
