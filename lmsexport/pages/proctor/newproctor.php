...
<div class="main_content">
    ...
    <div id="title_ui" class="col-md-12 pt-4">
        <h3> Proctor(s) >> Creating New Proctor</h3>
    </div>
        ...
        <div class="container">
            ...
            <div class="row rowStyle" style="width:100%;text-align:left">
                ...
                <div class="col-md-6">
                    ...
                    title="Enter valid mobile no" pattern="/^[0-9]{10,14}+$/" minlength="10" 
                    maxlength="14" value="<?php if (isset($_POST['mobileno'])) {
                                              echo $_POST['mobileno'];
                                          } ?>" />
                </div>
            ...
            <div class="row rowStyle" style="width:100%;text-align:left">
                ...
                <div class="col-md-6">
                    ...
                    value="<?php if (isset($_POST['paswrd'])) {
                               echo $_POST['paswrd'];
                           } ?>" />
